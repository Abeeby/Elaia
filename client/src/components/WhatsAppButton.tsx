...
export default function WhatsAppButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 left-8 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 group"
