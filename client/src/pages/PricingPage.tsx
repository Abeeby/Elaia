...
import { Check, Star, TrendingUp, Heart, Target, Gift, Users, Clock, ArrowRight, ChevronRight, Lock } from 'lucide-react';
...
export default function PricingPage() {
  const [selectedTab, setSelectedTab] = useState<'decouverte' | 'credits' | 'abonnements'>('abonnements');
  ...
  const handlePurchase = (e: React.MouseEvent) => {
    e.preventDefault();
    if (!isAuthenticated) {
      customToast.error('Veuillez vous connecter pour accéder aux offres');
      navigate('/login');
    } else {
      navigate('/register');
    }
              ...
              <div className="group relative">
                <div className="bg-elaia-white h-full flex flex-col p-8 border border-elaia-muted shadow-sm hover:shadow-lg transition-all duration-300">
                  ...
                  <button 
                    ...
                    className="btn-primary text-center mt-auto flex items-center justify-center gap-2"
                  >
