  ...
  const courses: Course[] = [
    {
      ...
      description: 'Kombinieren moderner Pilates-Übungen mit Elementen aus dem funktionellen Training für einen Körper und Geist.',
      intensity: 4,
      duration: '50 min',
    ...
    },
    {
      ...
      description: 'Nach Dynamic kommt Power – eine intensive Abwandlung des klassischen Pilates, erhöht durch funktionelles Krafttraining.',
      intensity: 5,
      duration: '50 min',
      participants: '6 personnes max',
      credits: 3,
    ...
    },
    {
      ...
      description: 'Barre Deep ist ein ganzheitliches Workout, das Technik der Barre mit Beweglichkeit verknüpft. Inspiriert von Yoga, Pilates und Ballett.',
      intensity: 3,
      duration: '50 min',
        ...
        {Array.from({ length: 5 }, (_, i) => (
          <div
            ...
            className={`h-1 w-6 rounded ${
              i < level ? 'bg-elaia-gold' : 'bg-gray-300'
            }`}
          />
        ))}
      </div>
